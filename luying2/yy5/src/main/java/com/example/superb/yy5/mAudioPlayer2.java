...
public class mAudioPlayer2 {
    private PipedInputStream instream;
    private boolean isPlaying ;
    private AudioTrack audioplayer;
    private byte[] buffer;
    public mAudioPlayer2() {
        isPlaying = false;
        instream = null;
        //初始化播音类
        @SuppressWarnings("deprecation")

        int bufsize = AudioTrack.getMinBufferSize(11025, AudioFormat.CHANNEL_OUT_STEREO,
                AudioFormat.ENCODING_PCM_16BIT);
        audioplayer = new AudioTrack(AudioManager.STREAM_RING, 11025, AudioFormat.CHANNEL_OUT_STEREO,
